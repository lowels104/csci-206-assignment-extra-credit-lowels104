...
public class dining {
	public static void main(String[] args){
        ...
        JLabel labeldiner4;
        JLabel labeldiner5;
        JLabel labelleftstick;
        JLabel labelrightsick;
        JLabel labelbites;
        JCheckBox diner1left;
        JCheckBox diner1right;
        JCheckBox diner2left;
        JCheckBox diner2right;
        JCheckBox diner3left;
        JCheckBox diner3right;
        JCheckBox diner4left;
        JCheckBox diner4right;
        JCheckBox diner5left;
        JCheckBox diner5right;*/
